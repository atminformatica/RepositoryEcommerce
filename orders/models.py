...
class Order(models.Model):
    ...
    #estamos associando dois campos diferentes ao modelo Address, isso pode confundir o Django por isso usamos related_name
...
#SIGNAL -  CRIA ID AUTOMATICO PARA A ORDER
def pre_save_create_order_id(sender, instance, *args, **kwargs):
    ...
    if qs.exists():
        qs.update = False
#RELACIONA A FUNCAO ACIMA COM O MODEL ORDER
